...
@Component({
  selector: 'app-mobileinspection-create',
  templateUrl: './mobileinspection-create.component.html',
  styleUrls: ['./mobileinspection-create.component.scss']
})
export class MobileinspectionCreateComponent implements OnInit {
