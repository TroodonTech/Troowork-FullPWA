...
@Component({
  selector: 'app-mobileview-work',
  templateUrl: './mobileview-work.component.html',
  styleUrls: ['./mobileview-work.component.scss']
})
export class MobileviewWorkComponent implements OnInit {
  Employee; Facility; Status;
