...
@Component({
  selector: 'app-mobilecreate-work',
  templateUrl: './mobilecreate-work.component.html',
  styleUrls: ['./mobilecreate-work.component.scss']
})
export class MobilecreateWorkComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.WorkOrderServiceService//for getting all building names
      .setgetallFacility(this.employeeKey, this.org_id)
      .subscribe((data: any[]) => {
        this.facilitylist = data;
      });
    this.WorkOrderServiceService//for getting all workordertypes
      .setgetallworkorderType(this.employeeKey, this.org_id)
      .subscribe((data: any[]) => {
    ...
    this.WorkOrderServiceService//for getting all priority names
      .setgetallPriority(this.org_id)
      .subscribe((data: any[]) => {
        this.priorityList = data;
      });
    this.WorkOrderServiceService//for getting employeenames
      .setgetallEmployee(this.employeeKey, this.org_id)
      .subscribe((data: any[]) => {
