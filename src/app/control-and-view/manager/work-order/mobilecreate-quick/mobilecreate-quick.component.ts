...
@Component({
  selector: 'app-mobilecreate-quick',
  templateUrl: './mobilecreate-quick.component.html',
  styleUrls: ['./mobilecreate-quick.component.scss']
})
export class MobilecreateQuickComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.WorkOrderServiceService//service for getting employee names
      .setgetallEmployee(this.emp_key, this.org_id)
      .subscribe((data: any[]) => {
        this.EmployeeOption = data;
      });
    this.WorkOrderServiceService//service for getting building names
      .setgetallFacility(this.emp_key, this.org_id)
      .subscribe((data: any[]) => {
