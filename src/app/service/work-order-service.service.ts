...
export class WorkOrderServiceService {
  ...
  // Amritha Code Starts here
 // mob_workorder
 setgetallPriority(org_id) {

  return this
    .http
    // .get(ConectionSettings.Url + '/allpriority?OrganizationID=' + org_id);
    .get(ConectionSettings.Url + '/mob_allpriority?OrganizationID=' + org_id);
}
setgetallworkorderType(emp_key, org_id) {
  return this
    .http
    .get(ConectionSettings.Url + '/mob_allWorkordertype?empkey=' + emp_key + '&OrganizationID=' + org_id);
}
setgetallEmployee(emp_key, org_id) {
  // return this
  //   .http
  //   .get(ConectionSettings.Url + '/employeeForManager?empkey=' + emp_key + '&OrganizationID=' + org_id);
  return this
    .http
    .get(ConectionSettings.Url + '/mob_allemployees?empkey=' + emp_key + '&OrganizationID=' + org_id);
}
setgetallFacility(empKey, orgID) {
  return this
    .http
    // .get(ConectionSettings.Url + '/allfacility?empkey=' + emp_key + '&OrganizationID=' + org_id);
    .get(ConectionSettings.Url + '/mob_allfacility?empkey=' + empKey + '&OrganizationID=' + orgID);
}
